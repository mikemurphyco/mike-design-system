...
A one-shot local Figma plugin that builds the entire Mike Murphy / AI Handyman v2026.4 design system into your current Figma file — variables, text styles, and all 16 reference frames. No Figma MCP calls, no quota.
...
- Ensures the variable collection `Mike Murphy v2026.4` exists with all primitive colors, semantic aliases, spacing, radii, font-size, line-height, and letter-spacing tokens.
